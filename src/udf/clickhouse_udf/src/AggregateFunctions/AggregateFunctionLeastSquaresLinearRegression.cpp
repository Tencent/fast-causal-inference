...
[[maybe_unused]] AggregateFunctionPtr createAggregateFunctionLeastSquaresLinearRegression(
    const std::string & name, const DataTypes & argument_types, const Array & parameters, const Settings *)
{
    ...
    if (parameters.size() > 1 && parameters[1].getType() != Field::Types::Bool)
...
void registerAggregateFunctionLeastSquaresLinearRegression([[maybe_unused]] AggregateFunctionFactory & factory)
{
