...
#if ENABLE_VECTOR_BITMAP
void registerAggregateFunctionsVectorBitmap(AggregateFunctionFactory & factory);
#endif
void registerAggregateFunctionMatrixOperator(AggregateFunctionFactory &);
void registerAggregateFunctionSRM(AggregateFunctionFactory &);
void registerAggregateFunctionKolmogorovSmirnovTest(AggregateFunctionFactory & factory);
void registerAggregateFunctionBootStrap(AggregateFunctionFactory & factory);
void registerAggregateFunctionPermutation(AggregateFunctionFactory & factory);
...
#if ENABLE_VECTOR_BITMAP
        registerAggregateFunctionsVectorBitmap(factory);
#endif
        registerAggregateFunctionLeastSquaresLinearRegression(factory);
        registerAggregateFunctionDeltaMethod(factory);
        registerAggregateFunctionMatrixOperator(factory);
        registerAggregateFunctionSRM(factory);
        registerAggregateFunctionKolmogorovSmirnovTest(factory);
        registerAggregateFunctionBootStrap(factory);
        registerAggregateFunctionPermutation(factory);
        registerAggregateFunctionGroupSet(factory);
        registerAggregateFunctionCausalForest(factory);
        registerAggregateFunctionMatchingInfo(factory);
