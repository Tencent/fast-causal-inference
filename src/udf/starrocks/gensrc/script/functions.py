...
vectorized_functions = [
    ...
    [1500001, 'array_size', 'INT', ['ANY_ARRAY'], 'ArrayFunctions::array_length'],
    ...
    [200000, 'eval_ml_method', 'DOUBLE', ['JSON', 'ARRAY_DOUBLE'], 'EvalMLMethod::eval_ml_method', 'EvalMLMethod::eval_prepare',
     'EvalMLMethod::eval_close'],
    
    # caliper matching
    [200010, "caliper_matching", "BIGINT", ['JSON', 'BOOLEAN', 'DOUBLE', 'DOUBLE'], 'CaliperMatchingFunction::caliper_matching', 
     'CaliperMatchingFunction::prepare', 'CaliperMatchingFunction::close'],
    
    # caliper matching
    [200011, "caliper_matching", "BIGINT", ['JSON', 'BOOLEAN', 'DOUBLE', 'DOUBLE', 'ARRAY_DOUBLE'], 'CaliperMatchingFunction::caliper_matching', 
     'CaliperMatchingFunction::prepare', 'CaliperMatchingFunction::close'],
]
