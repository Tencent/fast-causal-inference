...
public class StarRocksSqlDialect extends SqlDialect {
  ...
  @Override public @Nullable SqlNode getCastSpec(RelDataType type) {
    if (type instanceof BasicSqlType) {
      ...
      switch (typeName) {
      case VARCHAR:
        return createSqlDataTypeSpecByName("varchar", typeName);
      case TINYINT:
        return createSqlDataTypeSpecByName("tinyint", typeName);
      case SMALLINT:
        return createSqlDataTypeSpecByName("smallint", typeName);
      case INTEGER:
        return createSqlDataTypeSpecByName("int", typeName);
      case BIGINT:
        return createSqlDataTypeSpecByName("bigint", typeName);
      case FLOAT:
        return createSqlDataTypeSpecByName("float", typeName);
      case DOUBLE:
        return createSqlDataTypeSpecByName("double", typeName);
      case DATE:
...
//      toFunc = "toTime";
      ...
      throw new RuntimeException("StarRocks does not support DateTime literal: "
          + literal);
    }
